...
const Client = sequelize.define('Client', {
  ...
  tipo_empresa: { type: DataTypes.STRING(160), allowNull: true },
  ...
  rep_tel1: { type: DataTypes.STRING(100), allowNull: true },
  rep_tel2: { type: DataTypes.STRING(100), allowNull: true },
  rep_email: { type: DataTypes.STRING(160), allowNull: true },
  ...
  gestor_tel1: { type: DataTypes.STRING(100), allowNull: true },
  gestor_tel2: { type: DataTypes.STRING(100), allowNull: true },
  gestor_email: { type: DataTypes.STRING(160), allowNull: true },
  ...
  socio1_nome: { type: DataTypes.STRING(160), allowNull: true },
  socio1_cpf: { type: DataTypes.STRING(20), allowNull: true },
